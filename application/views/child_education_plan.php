...
<body class="co-fluidntainer wrapper"> 
    ...
    <div class="body_wrapper body_color">
      <div>
       	 <div class="retaire1">Child Education Plan....</div>
         	<!--code for form-->
            <div class="retaire2">Comparison Form....</div>
            <div class="retaired_form">
            	<form action="<?php echo base_url() ?>compare/child_education_plan" method="get">
                    ...
                    <div class="retaired_form2">
                        ...
                        <input name="btn_child_education_plan" type="submit" value="Submit">
                    </div>
                </form>
            </div>
