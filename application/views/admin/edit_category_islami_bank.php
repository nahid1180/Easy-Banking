    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <form name="edit_category_form" class="form-horizontal" action="<?php echo base_url(); ?>super_admin/update_category_islami_bank" method="post">
                    <fieldset>
                        <legend>Edit Category Islami Bank</legend>
