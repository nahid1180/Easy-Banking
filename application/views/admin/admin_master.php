                ...
                <div class="span2 main-menu-span">
                    <div class="well nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_category_deposit.html"><i class="icon-eye-open"></i><span class="hidden-tablet"> Add category Deposit</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_category_dps.html"><i class="icon-eye-open"></i><span class="hidden-tablet"> Add category DPS</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_category_islami_bank.html"><i class="icon-eye-open"></i><span class="hidden-tablet"> Add category Islami Bank</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_category_credit_card.html"><i class="icon-eye-open"></i><span class="hidden-tablet"> Add category Credit Card</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/manage_category_deposit"><i class="icon-edit"></i><span class="hidden-tablet">Manage Category deposit</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/manage_category_dps"><i class="icon-edit"></i><span class="hidden-tablet">Manage Category dps</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/manage_category_islami_bank"><i class="icon-edit"></i><span class="hidden-tablet">Manage Category Islami Bank</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/manage_category_credit_card"><i class="icon-edit"></i><span class="hidden-tablet">Manage Category Credit Card</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_bank"><i class="icon-list-alt"></i><span class="hidden-tablet">Add Bank</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/manage_bank"><i class="icon-edit"></i><span class="hidden-tablet">Manage Bank</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_deposit"><i class="icon-list-alt"></i><span class="hidden-tablet">add Deposit</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_islami_deposit"><i class="icon-list-alt"></i><span class="hidden-tablet">add Islamic Deposit</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_description"><i class="icon-list-alt"></i><span class="hidden-tablet">Add Description</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_description_islami"><i class="icon-list-alt"></i><span class="hidden-tablet">Add Description Islamic</span></a></li>
                             <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_credit_card"><i class="icon-list-alt"></i><span class="hidden-tablet">Add Credit Card</span></a></li>
                            <?php
                            $access_level = $this->session->userdata('access_level');
                            if ($access_level == 1) {
                                ?>
                                <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_monthly_dps"><i class="icon-list-alt"></i><span class="hidden-tablet">Add Monthly DPS</span></a></li>
                                <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_fixed_dps"><i class="icon-font"></i><span class="hidden-tablet"> Add Fixed DPS</span></a></li>
                                <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_retirement"><i class="icon-font"></i><span class="hidden-tablet"> Add Retirement Plan</span></a></li>
                                <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_marriage_dps"><i class="icon-list-alt"></i><span class="hidden-tablet">add Marriage DPS</span></a></li>
                                <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_education_savings"><i class="icon-list-alt"></i><span class="hidden-tablet">Add Education Savings</span></a></li>
                                <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_child_education"><i class="icon-list-alt"></i><span class="hidden-tablet">Add Child Education</span></a></li>
                                <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_hajj"><i class="icon-list-alt"></i><span class="hidden-tablet">Add Hajj</span></a></li>
