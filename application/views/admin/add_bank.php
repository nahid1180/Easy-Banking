			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
                                            <form class="form-horizontal" action="<?php echo base_url();?>super_admin/save_bank" method="post" enctype="multipart/form-data">
						  <fieldset>
							<legend>Add Bank</legend>
							<div class="control-group">
							  <label class="control-label" for="typeahead">Bank Name </label>
							  <div class="controls">
								<input type="text" name="bank_name" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" >
							...
							<div class="form-actions">
                                                          <button type="submit" class="btn btn-primary" name="btn">Save Bank</button>
