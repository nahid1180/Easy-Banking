    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <form class="form-horizontal" action="<?php echo base_url(); ?>super_admin/save_hajj" method="post">
                    <fieldset>
                        <legend>Add Hajj DPS</legend>
                        ...
                        <div class="control-group">
                           <div class="control-group">
                            ...
                            <label class="control-label" for="typeahead">Amount Payable</label>
                             <div class="controls">
                                <input type="text" name="amount_payable" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" >
                                <!--<p class="help-block">Start typing to activate auto complete!</p>-->
                            </div>
                            <label class="control-label" for="typeahead">Deposit Amount</label>
                             <div class="controls">
                                <input type="text" name="deposit_amount" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" >
                                <!--<p class="help-block">Start typing to activate auto complete!</p>-->
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="textarea2">Hajj Description</label>
                            <div class="controls">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-primary" name="btn">Save Hajj</button>
