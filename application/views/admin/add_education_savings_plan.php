    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <form class="form-horizontal" action="<?php echo base_url(); ?>super_admin/save_education_savings" method="post">
                    <fieldset>
                        <legend>Add Monthly DPS</legend>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-primary" name="btn">Save Education Savings Plan</button>
