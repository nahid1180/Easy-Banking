    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <form class="form-horizontal" action="<?php echo base_url(); ?>super_admin/save_islami_deposit" method="post">
                    <fieldset>
                        <legend>Add Islamic Deposit</legend>
                        <div class="controls">
                            <select name="bank_id">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-primary" name="btn">Save Islamic Deposit</button>
                        </div>
                    </fieldset>
                </form>   
